package com.venafan.generator.utils;

import com.venafan.generator.entity.ColumnEntity;
import com.venafan.generator.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                String name = Objects.requireNonNull(getFileName(template, tableEntity.getClassName(),
